		...
		<Flex flexDirection="column" className={css({ margin: "80px" })}>
			...
			<Form>
				...
				<Caption className={css({ textAlign: "center", display: "block" })}>
					You can obtain your translationstudio license from your account at {' '}<TextLink href="https://account.translationstudio.tech">https://account.translationstudio.tech</TextLink>{' '}
				</Caption>
			</Form>
